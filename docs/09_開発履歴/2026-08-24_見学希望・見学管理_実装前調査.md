...
[visits.md](../05_データベース設計/visits.md) より: _「カラム単位の更新制限は RLS だけでは複雑になるため、Server Action または DB 関数で制御する」_
...
| 8   | **確定後の詳細住所通知**                  | [breeders.md](../05_データベース設計/breeders.md): _「見学日程確定後の詳細住所通知方法は、見学フロー設計で別途定義」_ — **未設計** |
