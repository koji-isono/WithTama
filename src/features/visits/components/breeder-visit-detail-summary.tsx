...
type BreederVisitDetailSummaryProps = {
...
export function BreederVisitDetailSummary({ summary }: BreederVisitDetailSummaryProps) {
  return (
      ...
      <CardContent className="flex flex-col gap-5 p-5 sm:flex-row sm:items-start">
        ...
        <div className="min-w-0 flex-1 space-y-3">
          ...
          <div className="space-y-2 border-t border-[var(--border)] pt-3">
            ...
            <DetailRow label="問い合わせ開始日" value={summary.inquiryCreatedAtLabel} />
            ...
            <DetailRow label="内部メモ" value={summary.breederNote} />
          </div>
