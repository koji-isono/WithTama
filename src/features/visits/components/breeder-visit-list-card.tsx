...
import type { BreederVisitListItem } from "../types";

type BreederVisitListCardProps = {
  item: BreederVisitListItem;
};
...
export function BreederVisitListCard({ item }: BreederVisitListCardProps) {
